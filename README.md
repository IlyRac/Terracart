# 🚗 TerraCart — Vanilla Friendly Land Vehicle Mod for Minecraft

**TerraCart** adds a simple, drivable land cart to Minecraft that feels simple and fun.
...
* 🧭 Easy steering and movement (use normal keys)
* ⛽ Simple fuel system — refuel with **coal blocks**
* 🔈 Sound for **movement**, **hurt**, **refueled**
* 🛞 Animated wheels while moving
* 🎨 16 color variants (craftable with dyes)
* 📊 On-screen **speed & fuel** display while riding
* ✨ Particle effects for movement, refuel, and hurt
